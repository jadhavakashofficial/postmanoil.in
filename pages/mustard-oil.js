...
export default function MustardOilPage() {
  ...
  return (
    <>
      <Head>
        <title>Kacchi Ghani Mustard Oil Collection | Postman Oils - Premium Cold-Pressed Mustard Oil</title>
        <meta name="description" content="Shop premium Kacchi Ghani Mustard Oil from Postman Oils. Cold-pressed, pure, and traditionally made. Available on Amazon, Flipkart & JioMart with direct buy options." />
        <meta name="keywords" content="kacchi ghani mustard oil, cold pressed mustard oil, postman oil, traditional mustard oil, pure mustard oil" />
        <meta property="og:title" content="Premium Kacchi Ghani Mustard Oil | Postman Oils" />
        <meta property="og:description" content="Authentic cold-pressed mustard oil made with traditional methods. 55+ years of trust." />
        <link rel="canonical" href="https://postmanoil.com/mustard-oil" />
      </Head>

      {/* Hero Section */}
      <section className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 py-20 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-7xl font-black mb-6">
            Kacchi Ghani <span className="text-yellow-200">Mustard Oil</span>
          </h1>
          <p className="text-2xl md:text-3xl font-bold mb-4">
            Pure • Cold-Pressed • Traditional • Authentic
          </p>
          <p className="text-xl opacity-90 max-w-3xl mx-auto">
            Experience the authentic taste and health benefits of our premium mustard oil
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-orange-600 via-red-500 to-pink-600 bg-clip-text text-transparent">
              Our Mustard Oil Collection
            </h2>
            <p className="text-xl text-gray-700 font-medium">
              <span className="font-bold text-orange-600">{products.length} Premium Products</span> • Available with Direct Purchase Options
            </p>
          </div>
          ...
          {currentProducts.length > 0 ? (
                  ...
                  <div className="flex space-x-2">
                    {currentPage > 1 && (
                      <button
                        ...
                        className="px-4 py-2 bg-white text-orange-600 border-2 border-orange-600 rounded-lg hover:bg-orange-600 hover:text-white transition-colors font-bold"
                      >
                        Previous
                      </button>
                    )}
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">No Mustard Oil Products Found</h3>
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-orange-100">
      ...
      <Link href={`/product/${product.id}`}>
        <div className="relative h-48 md:h-56 overflow-hidden bg-gradient-to-br from-yellow-50 to-orange-50 cursor-pointer">
          <img
      ...
      <div className="p-3 md:p-4">
        ...
        <Link href={`/product/${product.id}`}>
          <h3 className="font-bold text-gray-900 text-sm md:text-base mb-3 cursor-pointer hover:text-orange-600 transition-colors line-clamp-2 min-h-[2.5rem] leading-tight">
            {product.name}
          </h3>
        </Link>
